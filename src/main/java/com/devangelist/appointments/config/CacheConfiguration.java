package com.devangelist.appointments.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.devangelist.appointments.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.devangelist.appointments.repository.UserRepository.USERS_BY_EMAIL_CACHE);
