...
import com.devangelist.appointments.repository.ServiceRepository;
...
public class ServiceResourceIT {
    ...
    public static Service createEntity(EntityManager em) {
        Service service = new Service().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).duration(DEFAULT_DURATION);
        return service;
    }
    ...
    public static Service createUpdatedEntity(EntityManager em) {
        Service service = new Service().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).duration(UPDATED_DURATION);
        return service;
    }
    ...
    public void updateService() throws Exception {
        ...
        updatedService.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).duration(UPDATED_DURATION);
